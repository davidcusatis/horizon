...
class TestCreateEditDeleteProject(helpers.AdminTestCase):
    ...
    def test_create_edit_delete_project(self):
        ...
        self.projects_page.edit_project_name(PROJECT_NAME, new_project_name)
        self.assertTrue(self.projects_page.is_project_present(new_project_name))

        self.projects_page.bring_up_delete_project_modal(new_project_name)
        self.assertIn(new_project_name, self.projects_page.delete_project_modal_body.text)

        self.projects_page.close_delete_project_modal()
        self.assertFalse(self.projects_page.is_project_present(new_project_name))
