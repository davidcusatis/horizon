...
class ComplexActionRowRegion(BaseActionRowRegion):
    ...
    _inline_project_name_edit_button_locator = (by.By.CSS_SELECTOR, 'button.ajax-inline-edit')

    _inline_project_name_input_text_locator = (by.By.CSS_SELECTOR, 'div.inline-edit-form > input')

    _inline_edit_submit_locator = (by.By.CSS_SELECTOR, '.inline-edit-submit')
    ...
    def _get_inline_edit_action(self):
        return self._get_element(*self._inline_project_name_edit_button_locator)

    def _get_inline_edit_text_box(self):
        return self._get_element(*self._inline_project_name_input_text_locator)
